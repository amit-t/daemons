...
export const CLAUDE_AUTO_RESUME_DISABLE_FLAG = "AICO_CLAUDE_AUTO_RESUME_DAEMON";
export const CLAUDE_AUTO_RESUME_STATE_DIR = "AICO_STATE_DIR";
...
export function claudeAutoResumeStateDirectory(env: Record<string, string | undefined> = process.env): string {
  return env[CLAUDE_AUTO_RESUME_STATE_DIR] || join(env.XDG_STATE_HOME || join(homedir(), ".local", "state"), "ai-cmux-orchestrator");
}
...
export async function registerClaudeSurfaceFromOrchestratorContext(
