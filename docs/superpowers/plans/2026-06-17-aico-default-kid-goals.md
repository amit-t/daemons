# AICO Default Kid-Panel Goal Orchestration Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Make AICO base orchestrators attempt kid-panel decomposition for ordinary tasks and require every delegated kid-panel assignment to be marked as a goal.
...
**Files:**
- Modify: `codex/ai-cmux-orchestrator/test/ai-cmux-orchestrator-panels.test.ts`
...
```zsh
cd codex/ai-cmux-orchestrator && bun test test/ai-cmux-orchestrator-panels.test.ts --test-name-pattern "decompose ordinary tasks"
```
...
```zsh
cd codex/ai-cmux-orchestrator && bun test test/ai-cmux-orchestrator-panels.test.ts
```
...
Update the AICO repository summary to mention default kid-panel orchestration and goal-marking assignments.
...
```zsh
cd codex/ai-cmux-orchestrator && bun test
```
...
```zsh
cd codex/ai-cmux-orchestrator && bun run typecheck
```
...
```zsh
zsh -n aliases.zsh
zsh -n codex/ai-cmux-orchestrator/bin/aico
zsh -n codex/ai-cmux-orchestrator/bin/ai-cmux-orchestrator
```
...
```zsh
git status --short
git add README.md docs/superpowers/specs/2026-06-17-aico-default-kid-goals-design.md docs/superpowers/plans/2026-06-17-aico-default-kid-goals.md codex/ai-cmux-orchestrator/README.md codex/ai-cmux-orchestrator/src/ai-cmux-orchestrator/orchestrator.ts codex/ai-cmux-orchestrator/test/ai-cmux-orchestrator-panels.test.ts
git commit -m "feat(aico): default kid-panel goal orchestration"
