import { defaultRunner, type CommandRunner } from "./orchestrator.ts";
import {
...
export interface AiCmuxOrchestratorDaemonOptions {
...
export async function runAiCmuxOrchestratorDaemon(options: AiCmuxOrchestratorDaemonOptions = {}): Promise<never> {
